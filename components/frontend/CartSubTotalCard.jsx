  ...
  return (
    <div className="md:col-span-4 col-span-full sm:block  bg-white border border-gray-300 dark:border-gray-700 rounded-lg dark:bg-gray-800 text-slate-800 overflow-hidden p-5">
              ...
              <div className='flex items-center justify-between dark:text-slate-100 pb-6 border-t border-gray-600 py-4'>
                ...
                <span className='text-2xl'>{formattedTotalPrice} <small>col</small></span>
              </div>
              <div className='mt-8'>
              <Link href='/checkout' className='text-slate-100 dark:text-slate-900 dark:hover:text-white bg-slate-600  dark:bg-slate-200 dark:hover:bg-lime-500 hover:bg-lime-500 transition-all duration-300 hover:text-slate-100 rounded-lg py-3 px-12 font-bold'>
              Continuar con CheckOut</Link>
              </div>
