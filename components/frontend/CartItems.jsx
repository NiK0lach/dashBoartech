           ...
           {cartItems.length > 0 && (
            <>
              ...
              <div className="flex items-center gap-2 py-4 px-3">
                <input type="text" id="email" aria-describedby='helper-text-explanation' className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-1/2" placeholder="name@electrnik.com"/>
