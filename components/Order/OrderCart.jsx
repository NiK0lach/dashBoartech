...
export default function OrderCart({order}) {
  ...
  return (
    <li className="overflow-hidden bg-white dark:bg-slate-100 border border-gray-200 rounded-md">
                    <div className="lg:flex">
                        <div className="w-full border-b border-gray-200 lg:max-w-xs lg:border-b-0 lg:border-r bg-gray-50 dark:bg-slate-200">
                        ...
                        <div className="flex-1 px-4 py-6 sm:p-6 lg:p-8">
                                                ...
                                                <div className="flex flex-col justify-between flex-1 ml-5">
                                                    <div className="sm:grid sm:grid-cols-2 sm:gap-x-5">
                                                        <div>
                                                            ...
                                                            <p className="mt-1.5 text-sm font-medium text-gray-500">{item.description}</p>
                                                        </div>

                                                        <div className="mt-4 sm:mt-0 flex items-center justify-between">
                                                        <p className="me-4 text-sm font-medium text-gray-500">{item.quantity} |</p>
                            ...
                            <div className="flex items-center mt-8 space-x-5">
                                ...
                                <Link
                                    href={`orders/${order.id}/invoice`} className="inline-flex items-center justify-center px-4 py-2.5 text-sm font-bold text-gray-900 transition-all duration-200 bg-white border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 hover:bg-gray-100"
                                >
                                    View Invoice
                                </Link>
                            </div>
